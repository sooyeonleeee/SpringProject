			...
			<div class="container">
				<div class="navbar-header" style="padding: 15px">
					...
					<div class="navbar-brand  navbar-brand-centered">
						<a href="<%=request.getContextPath()%>"> <img class="sky_log" src="resources/img/sky_log.png">
						</a>
					</div>
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav navbar-right">
						<c:if test="${ empty sessionScope.id}">
							...
							<li><a data-toggle="modal" href="#join"><button class="btn btn-info">회원가입</button></a></li>
						</c:if>
	...
	<script type="text/javascript">
		$(function() {
			$("#logoutbtn").click(function() {
				$.ajax({
					url : "http://localhost:8087/SpringProject/logout.do",
					dataType : "text",
					type : "POST",
