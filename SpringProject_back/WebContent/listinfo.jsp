		...
		<div class="panel-body" style="margin-left: 20px">
			...
			<div class="row">
				<div type="button" style="padding: 10px 175px" class="btn btn-default" data-toggle="collapse" data-target="#back2">
					<div class="col-sm-12 ">
						<div class="row listbox">
							<span>${item.destination }</span> <span><img alt="" src="http://localhost:8087/SpringProject/resources/img/arrow.png" width="50"> </span> <span><img alt="" src="http://localhost:8087/SpringProject/resources/img/airplane.png"> </span> <span>${item.origin }</span> <span id="down"><img alt="" src="http://localhost:8087/SpringProject/resources/img/arrow-down.png"></span>
						</div>
					</div>
					<!-- 						<img alt="" src="http://localhost:8087/SpringProject/resources/img/arrow-down.png"> -->
				</div>
