...
<div class="container">
	<div id="row" style="margin-top: 250px">
		<div class="well">
			<form class="form-inline" id="formsearch" action="http://localhost:8087/SpringProject/search?id=${sessionScope.id }" method="post">
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="2"><span class="col-sm-3"> <label for="path1"><input type="radio" class="form-control text-center" name="isOneWay" value="1" id="path1" checked="TRUE">왕복</label>
							</span> <span class="col-sm-3"> <label for="path2"><input type="radio" class="form-control text-center" name="isOneWay" value="0" id="path2">편도</label>
							</span></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
							<td colspan="4" class="text-center"><button type="button" id="search" class="btn btn-info">항공권검색</button></td>
						</tr>
					</tfoot>
				</table>
			</form>
